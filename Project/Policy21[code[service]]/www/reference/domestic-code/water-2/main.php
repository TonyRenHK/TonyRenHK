...
<tr><td>用戶編號﹕<input type = "text" name = "client_num" id = "client_num" value = "<?php echo @$ans["client_num"]; ?>"></td></tr>
</table>
</center></div>
<!-------------------------------------------------------start---------------------------------------------------------------------------------------->
<p>***********************************************************************************************************************************************************************************</p>
<p>你好，我是<input type = "text" name = "employee" id = "employee" value = "<?php echo @$ans["employee"]; ?>">,是政策二十一的訪問員。我們現正受水務署委託進行一項有關公眾對於用水的意見調查。我希望與 貴住戶內最熟悉用水情況的成員進行訪問。整個訪問約需要15分鐘。</p>
<P>(訪問員指引：如註冊用戶未能回答問卷 或 如由其他家庭成員回答問卷，請問及受訪者的稱呼及與戶主關係。受訪者必須為18歲或以上家庭成員。)</p>
<p>受訪者的稱呼：<input type = "text" name = "interviewee" id = "interviewee" value = "<?php echo @$ans["interviewee"]; ?>">與戶主關係：<input type = "text" name = "relation" id = "relation" value = "<?php echo @$ans["relation"]; ?>"></p>
<br>
<p><strong>請放心作答，你所提供的所有資料將會嚴加保密，並只作整體研究之用，受訪者的個別身份不會被披露。</strong></p>

<!---------------------------------------------------------------question start--------------------------------------------------------------------->
<div id="g1" class="orgbor">
<p><strong>1.根據水務署的年報，國際人均用水量平均約為每日110公升，而香港目前的人均用水量平均約為每日130公升。</strong></p>
<table>
		<tr>
			<td class = "left bold"><strong>1a. 你認為政府應該積極地宣傳節約用水？</strong></td>
		</tr>
		<tr>
		...
		<tr>
			<td class = "left bold" colspan = "3"><strong>1b. 你有使用什麼節約用水的措施嗎？</strong></td>
		</tr>
		<tr>
			<td class = "left" colspan = "3"> (訪問員指引：請讀出下列所有選項，並可選擇所有適用的選項‧)</td>
		</tr>
		<tr>
			<td class = "right"><input type = "checkbox" name = "q1_1b_1" id = "q1_1b_1" value = "1" <?php if (@$ans["q1_1b_1"] == "1") { echo "checked"; } ?>><label for = "q1_1b_1" >(a)在水龍頭安裝節流器</label></td>
		</tr>
		<tr>
			<td class = "right"><input type = "checkbox" name = "q1_1b_2" id = "q1_1b_2" value = "1" <?php if (@$ans["q1_1b_2"] == "1") { echo "checked"; } ?>><label for = "q1_1b_2" >(b)立即修理滴漏的器具</label></td>
		</tr>
		<tr>
			<td class = "right"><input type = "checkbox" name = "q1_1b_3" id = "q1_1b_3" value = "1" <?php if (@$ans["q1_1b_3"] == "1") { echo "checked"; } ?>><label for = "q1_1b_3" >(c)在水龍頭安裝節流器</label></td>
		</tr>
		<tr>
			<td class = "right"><input type = "checkbox" name = "q1_1b_4" id = "q1_1b_4" value = "1" <?php if (@$ans["q1_1b_4"] == "1") { echo "checked"; } ?>><label for = "q1_1b_4" >(d)在水龍頭安裝節流器</label></td>
		</tr>
		<tr>
			<td class = "right"><input type = "checkbox" name = "q1_1b_5" id = "q1_1b_5" value = "1" <?php if (@$ans["q1_1b_5"] == "1") { echo "checked"; } ?>><label for = "q1_1b_5" >(e)其他，請註明：</label><input type = "text" name = "q1_1b_5a" id = "q1_1b_5a" value = "<?php echo @$ans["q1_1b_5a"]; ?>"></td>
		</tr>
		<tr>
			<td class = "right"><input type = "checkbox" name = "q1_1b_6" id = "q1_1b_6" value = "1" <?php if (@$ans["q1_1b_6"] == "1") { echo "checked"; } ?>><label for = "q1_1b_6" >(f)沒有</label></td>
		</tr>
</table>
</div>
...
<div id="g2" class="orgbor">
	<table>
		<tr>
			<td class = "left bold" colspan = "4"><strong>2.你認為你的家庭每期(以四個月計)水費為多少才算可接受？請注意：水務署每四個月(為一期)收費一次。</strong></td>
		</tr>
		<tr>
...
<table>
		<tr>
			<td class = "left bold" colspan = "9"><strong>4.根據水務署的年報，於2012至2013年度每月平均水費為約相等於住戶每月平均開支的0.3%。</strong></td>
		</tr>
		<tr>
			<td class = "left bold" colspan = "3"><strong>4a.你認為你的家庭每月水費佔總支出多少百分比，才算可接受？</strong></td>			
		</tr>
		<tr>
...
<div id="g5" class="orgbor">
    <p><strong>5.根據水務署的年報，2012-2013年的赤字超過了10億元。如果政府會採取行動來減少超過10億元的赤字，</strong></p>
	<p><strong>你認為應該以多少年的時間，把赤字減至零，使政府不需要使用納稅人的公帑來補貼赤字差額？</strong></p>
	<p>(訪問員指引：請讀出下列所有選項，並只可選擇一項最合適用的選項‧)</p>
<table>
	<tr>
	 ...
	 <tr>	
	   <td class = "right"><input type = "radio" name = "q5" id = "q5_e" value = "05" <?php if (@$ans["q5"] == "05") { echo "checked"; } ?>><label for = "q5_e" >(e)其他建議，請註明：</label><input type = "text" name = "q5_e" id = "q5_e" value = "<?php echo @$ans["q5_e"]; ?>"></td>		
	</tr>
</table>
</div>
<br>
...
<div id="g6" class="orgbor">
   ...
   <p><strong>6.請指出你對水務署服務的滿意程度。</strong></p>
   <p><i>以下是以(1)至(10)來評分‧選(1)至(5)代表不滿意，選(6)至(10)分代表滿意。</i></p>
 <table>
...
<div id="g7" class="orgbor">
  <p><strong>7.請排序以下因素的重要程度。以下是以(1)至(5)來排序‧選(1)代表你認為這項因素是最重要的，選(2)代表你認為這項因素是次重要的，如此類推。請給每項排序。</strong></p>
  <table>
	<tr><td>&nbsp;&nbsp;&nbsp;因素</td><td>排序</td><td>如有需要，請註明</td></tr>
	<tr><td>●食水水質</td><td> <select name="q7_1"><option value="0"selected="selected">  </option><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option></td> <td><input type = "text" name = "q7_1a" id = "q7_1a" value = "<?php echo @$ans["q7_1a"]; ?>"></td></tr>
	<tr><td>●食水供應的可靠度</td><td> <select name="q7_2"><option value="0" selected="selected">  </option><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option></td> <td><input type = "text" name = "q7_2a" id = "q7_2a" value = "<?php echo @$ans["q7_2a"]; ?>"></td></tr>
	<tr><td>●水費</td><td> <select name="q7_3"><option value="0"selected="selected">  </option><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option></td> <td><input type = "text" name = "q7_3a" id = "q7_3a" value = "<?php echo @$ans["q7_3a"]; ?>"></td></tr>
	<tr><td>●客戶服務</td><td> <select name="q7_4"><option value="0"selected="selected">  </option><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option></td> <td><input type = "text" name = "q7_4a" id = "q7_4a" value = "<?php echo @$ans["q7_4a"]; ?>"></td></tr>
	<tr><td>●其他，請註明：<input type = "text" name = "q7_5c" id = "q7_5c" value = "<?php echo @$ans["q7_5c"]; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td> <select name="q7_5"><option value="0"selected="selected">  </option><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option></td><td><input type = "text" name = "q7_5a" id = "q7_5a" value = "<?php echo @$ans["q7_5a"]; ?>"></td></tr>	
  </table>
</div>
...
<table>
    <tr><td class = "left bold" colspan = "4"><strong>8.如果2015至2016年度調整水費，約有三分之二的住宅用戶每一期(以四個月計)水費帳單的加幅不超過$20，</strong></td></tr>
	<tr><td class = "left bold" colspan = "4"><strong>即每月不超過$5。</strong></td></tr>
	<tr><td class = "left bold" colspan = "4"><strong>8a. 你認為加幅可接受嗎？</strong></td></tr>
	<tr>
	...
	<tr>
		<td class = "right"><input type = "radio" name = "q8a" id = "q8a_3" value = "03" <?php if (@$ans["q8a"] == "03") { echo "checked"; } ?>><label for = "q8a_3" >(3)不可接受</label></td>
	...
	<tr>
		<td class = "right"><input type = "radio" name = "q8b" id = "q8b_3" value = "03" <?php if (@$ans["q8b"] == "03") { echo "checked"; } ?>><label for = "q8b_3" >(3)不能夠負擔</label></td>
		
	</tr>
	<tr><td class = "left bold" colspan = "4">若選擇 (3)不可接受 或 (4)完全不能接受，請註明原因：<input type = "text" name = "q8b_34" id = "q8b_34" value = "<?php echo @$ans["q8b_34"]; ?>" ></td></tr>
...
<table>
    <tr><td class = "left bold" colspan = "4"><strong>9.如果2015至2016年度調整水費，約有三分之二的住宅用戶每一期(以四個月計)水費帳單的加幅不超過$10，即每月不超過$2.5。</strong></td></tr>
	<tr><td class = "left bold" colspan = "4"><strong>9a. 你認為加幅可接受嗎？</strong></td></tr>
	<tr>
	    <td class = "right"><input type = "radio" name = "q9a" id = "q9a_1" value = "01" <?php if (@$ans["q9a"] == "01") { echo "checked"; } ?>><label for = "q9_1" >(1)完全可接受</label></td>
	    <td class = "right"><input type = "radio" name = "q9a" id = "q9a_4" value = "04" <?php if (@$ans["q9a"] == "04") { echo "checked"; } ?>><label for = "q_4" >(4)完全不能接受</label></td>
	</tr>
	<tr>
		<td class = "right"><input type = "radio" name = "q9a" id = "q9a_2" value = "02" <?php if (@$ans["q9a"] == "02") { echo "checked"; } ?>><label for = "q9_2" >(2)可接受</label></td>
		<td class = "right"><input type = "radio" name = "q9a" id = "q9a_5" value = "05" <?php if (@$ans["q9a"] == "05") { echo "checked"; } ?>><label for = "q9_5" >(5)沒有意見</label></td>
	</tr>
	<tr>
		<td class = "right"><input type = "radio" name = "q9a" id = "q9a_3" value = "03" <?php if (@$ans["q9a"] == "03") { echo "checked"; } ?>><label for = "q9_3" >(3)不可接受</label></td>
	...
	<tr>
		<td class = "right"><input type = "radio" name = "q9b" id = "q9b_3" value = "03" <?php if (@$ans["q9b"] == "03") { echo "checked"; } ?>><label for = "q9b_3" >(3)不能夠負擔</label></td>
		
	</tr>
	<tr><td class = "left bold" colspan = "4">若選擇 (3)不可接受 或 (4)完全不能接受，請註明原因：<input type = "text" name = "q9b_34" id = "q9b_34" value = "<?php echo @$ans["q9b_34"]; ?>"></td></tr>
...
<table>
     <tr><strong>10.請問可否提供你的家庭每月收入嗎？請包括所有在職家庭成員的工作收入及其他收入。</strong></tr>
	 <tr><td>(1)</td><td class = "right"><input type = "radio" name = "q10" id = "q10_1" value = "1" <?php if (@$ans["q10"] == "1") { echo "checked"; } ?>><label for = "q10_1" >可以，數目大概是 $</label><input type = "text" name = "q10_a" id = "q10_a" value = "<?php echo @$ans["q10_a"]; ?>"></td></tr>
	 <tr><td>(2)</td><td class = "right"><input type = "radio" name = "q10" id = "q10_2" value = "2" <?php if (@$ans["q10"] == "2") { echo "checked"; } ?>><label for = "q10_2" >如果不太清楚，能否在下列範圍選出大概數目嗎？</label></td></tr>
	 <tr><td></td>
	     <td>
		     <p>(a)<input type = "radio" name = "q10_2" id = "q10_2_1" value = "01" <?php if (@$ans["q10_2"] == "01") { echo "checked"; } ?>><label for = "q10_2_1" >$5,000 或以下</label></p>
			 <p>(b)<input type = "radio" name = "q10_2" id = "q10_2_2" value = "02" <?php if (@$ans["q10_2"] == "02") { echo "checked"; } ?>><label for = "q10_2_2" >$5,001 - $10,000</label></p>
			 <p>(c)<input type = "radio" name = "q10_2" id = "q10_2_3" value = "03" <?php if (@$ans["q10_2"] == "03") { echo "checked"; } ?>><label for = "q10_2_3" >$10,001 - $15,000</label></p>
			 <p>(d)<input type = "radio" name = "q10_2" id = "q10_2_4" value = "04" <?php if (@$ans["q10_2"] == "04") { echo "checked"; } ?>><label for = "q10_2_4" >$15,001 - $20,000</label></p>
			 <p>(e)<input type = "radio" name = "q10_2" id = "q10_2_5" value = "05" <?php if (@$ans["q10_2"] == "05") { echo "checked"; } ?>><label for = "q10_2_5" >$20,001 - $25,000</label></p>
			 <p>(f)<input type = "radio" name = "q10_2" id = "q10_2_6" value = "06" <?php if (@$ans["q10_2"] == "06") { echo "checked"; } ?>><label for = "q10_2_6" >$25,001 - $30,000</label></p>
			 <p>(g)<input type = "radio" name = "q10_2" id = "q10_2_7" value = "07" <?php if (@$ans["q10_2"] == "07") { echo "checked"; } ?>><label for = "q10_2_7" >$30,001 - $35,000</label></p>
			 <p>(h)<input type = "radio" name = "q10_2" id = "q10_2_8" value = "08" <?php if (@$ans["q10_2"] == "08") { echo "checked"; } ?>><label for = "q10_2_8" >$35,001 - $40,000</label></p>
			 <p>(i)<input type = "radio" name = "q10_2" id = "q10_2_9" value = "09" <?php if (@$ans["q10_2"] == "09") { echo "checked"; } ?>><label for = "q10_2_9" >$40,000 以上</label></p>
	 </td>
	 
	 </tr>
	 <tr><td>(3)</td><td class = "right"><input type = "radio" name = "q10" id = "q10_3" value = "3" <?php if (@$ans["q10"] == "3") { echo "checked"; } ?>><label for = "q10_3" >不能提供/ 拒絕回答。</label></td></tr>
</table>
</div>

<br>

<div id="g11" class="orgbor">
<table>
    <tr><td class = "left bold" colspan = "4"><strong>11.請指出你現時居住單住的住戶人數。請計算所有同住家庭成員的數目，包括家庭傭工及與共同享用生活所</strong></td></tr>
	<tr><td class = "left bold" colspan = "4"><strong>需的戶內人士。(例如，共同用膳。)</strong><input type = "text" name = "q11" id = "q11" value = "<?php echo @$ans["q11"]; ?>"></td></tr>
</table>
</div>
