...
<tr><td>****************************************************************************************************************************************</td></tr>
<tr><td>你好，我是<input type = "text" name = "employee" id = "employee" value = "<?php echo @$ans["employee"]; ?>">,是政策二十一的訪問員。我們現正受水務署委託進行一項有關公眾對於用水的意見調查。我希望與 貴住戶內最熟悉用水情況的成員進行訪問。整個訪問約需要15分鐘。</td></tr>
<tr><td>(訪問員指引：如註冊用戶未能回答問卷 或 如由其他家庭成員回答問卷，請問及受訪者的稱呼及與戶主關係。受訪者必須為18歲或以上家庭成員。)</td></tr>
<tr><td>受訪者的稱呼：<input type = "text" name = "interviewee" id = "interviewee" value = "<?php echo @$ans["interviewee"]; ?>">與戶主關係：<input type = "text" name = "relation" id = "relation" value = "<?php echo @$ans["relation"]; ?>"></td></tr>
<br>
<tr><td><strong>請放心作答，你所提供的所有資料將會嚴加保密，並只作整體研究之用，受訪者的個別身份不會被披露。</strong></td></tr>
...
<table width="1100" border="1" align="center">
		<tr >
		    <td colspan = "3"><strong>1.根據水務署的年報，國際人均用水量平均約為每日110公升，而香港目前的人均用水量平均約為每日130公升。</strong><br>
			<strong>1a. 你認為政府應該積極地宣傳節約用水？</strong></td>
		</tr>
		<tr>
		...
		<tr>
			<td class = "right" colspan = "3"><input type = "checkbox" name = "q1_1b_3" id = "q1_1b_3" value = "1" <?php if (@$ans["q1_1b_3"] == "1") { echo "checked"; } ?>><label for = "q1_1b_3" >(c)在水龍頭安裝節流器</label></td>
		</tr>
		<tr>
			<td class = "right" colspan = "3"><input type = "checkbox" name = "q1_1b_4" id = "q1_1b_4" value = "1" <?php if (@$ans["q1_1b_4"] == "1") { echo "checked"; } ?>><label for = "q1_1b_4" >(d)在水龍頭安裝節流器</label></td>
		</tr>
		<tr>
...
<table width="1100" border="1" align="center">
    <tr><td colspan = "3"><strong>5.根據水務署的年報，2012-2013年的赤字超過了10億元。如果政府會採取行動來減少超過10億元的赤字，<br>你認為應該以多少年的時間，把赤字減至零，使政府不需要使用納稅人的公帑來補貼赤字差額？<br>(訪問員指引：請讀出下列所有選項，並只可選擇一項最合適用的選項‧)</strong></td></tr>
	<tr>
...
<div id="g6" class="orgbor">
 <table width="1100" border="1" align="center">
   <tr><td colspan = "21"><strong>6.請指出你對水務署服務的滿意程度。</strong><br><i>以下是以(1)至(10)來評分‧選(1)至(5)代表不滿意，選(6)至(10)分代表滿意。</i></td></tr> 
...
<div id="g7" class="orgbor">
  <table width="1100" border="1" align="center">
    <tr><td colspan = "4"><strong>7.請排序以下因素的重要程度。以下是以(1)至(5)來排序‧選(1)代表你認為這項因素是最重要的，選(2)代表你認為這項因素是次重要的，如此類推。<br>請給每項排序。</strong></td></tr>
...
<table width="1100" border="1" align="center">
	...
	<tr>
		<td class = "right" colspan = "20"><input type = "radio" name = "q9a" id = "q9a_3" value = "03" <?php if (@$ans["q9a"] == "03") { echo "checked"; } ?>><label for = "q9_3" >(3)不可接受</label></td>	
	</tr>
...
<table width="1100" border="1" align="center">
     <tr><td colspan = "4"><strong>10.請問可否提供你的家庭每月收入嗎？請包括所有在職家庭成員的工作收入及其他收入。</strong></td></tr>
	 <tr><td>(1)</td><td class = "right" colspan = "3"><input type = "radio" name = "q10" id = "q10_1" value = "1" <?php if (@$ans["q10"] == "1") { echo "checked"; } ?>><label for = "q10_1" >可以，數目大概是 $</label><input type = "text" name = "q10_a" id = "q10_a" value = "<?php echo @$ans["q10_a"]; ?>"></td></tr>
	 <tr><td>(2)</td><td class = "right" colspan = "3"><input type = "radio" name = "q10" id = "q10_2" value = "2" <?php if (@$ans["q10"] == "2") { echo "checked"; } ?>><label for = "q10_2" >如果不太清楚，能否在下列範圍選出大概數目嗎？</label></td></tr>
	 <tr class="cg10_2"><td></td>
	     <td  colspan = "3">
		     <p>(a)<input type = "radio" name = "q10_2" id = "q10_2_1" value = "01" <?php if (@$ans["q10_2"] == "01") { echo "checked"; } ?>><label for = "q10_2_1" >$5,000 或以下</label>
	 ...
	 <tr><td>(3)</td><td class = "right" colspan = "3" ><input type = "radio" name = "q10" id = "q10_3" value = "3" <?php if (@$ans["q10"] == "3") { echo "checked"; } ?>><label for = "q10_3" >不能提供/ 拒絕回答。</label></td></tr>
</table>
</div>
