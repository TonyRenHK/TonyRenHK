...
//Tony for  test
	...
	$("#q1_1b_6").click(function() {
	    $("input[name='q1_1b_1']").prop("checked", false);
	    $("input[name='q1_1b_2']").prop("checked", false);
	    $("input[name='q1_1b_3']").prop("checked", false);
	    $("input[name='q1_1b_4']").prop("checked", false);
	    $("input[name='q1_1b_5']").prop("checked", false);
	});
