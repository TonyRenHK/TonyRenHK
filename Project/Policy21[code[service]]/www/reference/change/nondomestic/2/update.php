...
if (!(isset($_POST["login"]))) {
	...
	if ((isset($_POST["sub"]))||(isset($_POST["sub1"]))) {
		...
		$result = mysql_query($sql,$link);
		$sql = "insert into nondomesticdbbk(sc,eno,com_name,interviewee,position,status,st,ed,q1_1a,q1_1b_1,q1_1b_2,q1_1b_3,q1_1b_4,q1_1b_5,q1_1b_5a,q1_1b_6,q2a,q2a_34,q2b,q3_1,q3_2,q3_3,q3_4,q4_1,q4_1a,q4_2,q4_2a,q4_3,q4_3a,q4_4,q4_4a,q4_5c,q4_5,q4_5a,q5,q5_e,q6_1,q6_2,q6_3,q6_4,q6_5,q6_6,q6_7,q6_7a,q7_1,q7_2,q7_3,q7_4,q7_5,q7_6,q7_7,q7_7a,q8,q8_a,q8_2,q9,q9_1a,q9_1b,q9_2)values ('".$_POST["sc"]."','".$_POST["eno"]."','".$_POST["com_name"]."','".$_POST["interviewee"]."','".$_POST["position"]."','".$_POST["stat1"]."','".$_POST["stday"]." ".$_POST["sttime"]."','".$edday." ".$edtime."','".$_POST["q1_1a"]."','".$_POST["q1_1b_1"]."','".$_POST["q1_1b_2"]."','".$_POST["q1_1b_3"]."','".$_POST["q1_1b_4"]."','".$_POST["q1_1b_5"]."','".$_POST["q1_1b_5a"]."','".$_POST["q1_1b_6"]."','".$_POST["q2a"]."','".$_POST["q2a_34"]."','".$_POST["q2b"]."','".$_POST["q3_1"]."','".$_POST["q3_2"]."','".$_POST["q3_3"]."','".$_POST["q3_4"]."','".$_POST["q4_1"]."','".$_POST["q4_1a"]."','".$_POST["q4_2"]."','".$_POST["q4_2a"]."','".$_POST["q4_3"]."','".$_POST["q4_3a"]."','".$_POST["q4_4"]."','".$_POST["q4_4a"]."','".$_POST["q4_5c"]."','".$_POST["q4_5"]."','".$_POST["q4_5a"]."','".$_POST["q5"]."','".$_POST["q5_e"]."','".$_POST["q6_1"]."','".$_POST["q6_2"]."','".$_POST["q6_3"]."','".$_POST["q6_4"]."','".$_POST["q6_5"]."','".$_POST["q6_6"]."','".$_POST["q6_7"]."','".$_POST["q6_7a"]."','".$_POST["q7_1"]."','".$_POST["q7_2"]."','".$_POST["q7_3"]."','".$_POST["q7_4"]."','".$_POST["q7_5"]."','".$_POST["q7_6"]."','".$_POST["q7_7"]."','".$_POST["q7_7a"]."','".$_POST["q8"]."','".$_POST["q8_a"]."','".$_POST["q8_2"]."','".$_POST["q9"]."','".$_POST["q9_1a"]."','".$_POST["q9_1b"]."','".$_POST["q9_2"]."')";
		
		
		
		//$sql = "insert into nondomesticdbbk(sc,eno,relation,status,st,ed,q1_1a,q1_1b_1,q1_1b_2,q1_1b_3,q1_1b_4,q1_1b_5,q1_1b_5a,q1_1b_6,q2,q2_1a,q3,q3_1a,q4_a,q4_a_1a,q4_b,q4_b_1a,q5,q5_e,q6_1,q6_2,q6_3,q6_4,q7_1,q7_1a,q7_2,q7_2a,q7_3,q7_3a,q7_4,q7_4a,q7_5c,q7_5,q7_5a,q8a,q8a_34,q8b,q8b_34,q9a,q9a_34,q9b,q10,q10_2,q10_a,q11,q12,q12_4a)values ('".$_POST["sc"]."','".$_POST["eno"]."',,'".$_POST["relation"]."','".$_POST["stat"]."','".$_POST["stday"]." ".$_POST["sttime"]."','".$edday." ".$edtime."','".$_POST["q1_1a"]."','".$_POST["q1_1b_1"]."','".$_POST["q1_1b_2"]."','".$_POST["q1_1b_3"]."','".$_POST["q1_1b_4"]."','".$_POST["q1_1b_5"]."','".$_POST["q1_1b_5a"]."','".$_POST["q1_1b_6"]."','".$_POST["q2"]."','".$_POST["q2_1a"]."','".$_POST["q3"]."','".$_POST["q3_1a"]."','".$_POST["q4_a"]."','".$_POST["q4_a_1a"]."','".$_POST["q4_b"]."','".$_POST["q4_b_1a"]."','".$_POST["q5"]."','".$_POST["q5_e"]."','".$_POST["q6_1"]."','".$_POST["q6_2"]."','".$_POST["q6_3"]."','".$_POST["q6_4"]."','".$_POST["q7_1"]."','".$_POST["q7_1a"]."','".$_POST["q7_2"]."','".$_POST["q7_2a"]."','".$_POST["q7_3"]."','".$_POST["q7_3a"]."','".$_POST["q7_4"]."','".$_POST["q7_4a"]."','".$_POST["q7_5c"]."','".$_POST["q7_5"]."','".$_POST["q7_5a"]."','".$_POST["q8a"]."','".$_POST["q8a_34"]."','".$_POST["q8b"]."','".$_POST["q8b_34"]."','".$_POST["q9a"]."','".$_POST["q9a_34"]."','".$_POST["q9b"]."','".$_POST["q10"]."','".$_POST["q10_2"]."','".$_POST["q10_a"]."','".$_POST["q11"]."','".$_POST["q12"]."','".$_POST["q12_4a"]."')";
		//$sql = "insert into nondomesticdbbk (sc,scx,eno,employee,interviewee,relation,status,st,ed,q1_1a,q1_1b_1,q1_1b_2,q1_1b_3,q1_1b_4,q1_1b_5,q1_1b_5a,q1_1b_6,q2,q2_1a,q3,q3_1a,q4_a,q4_a_1a,q4_b,q4_b_1a,q5,q5_e,q6_1,q6_2,q6_3,q6_4,q7_1,q7_1a,q7_2,q7_2a,q7_3,q7_3a,q7_4,q7_4a,q7_5c,q7_5,q7_5a,q8a,q8a_34,q8b,q8b_34,q9a,q9a_34,q9b,q10,q10_2,q10_a,q11,q12,q12_4a) values ('".$_POST["sc"]."','".$scx."','".$_POST["eno"]."','".$_POST["employee"]."','".$_POST["interviewee"]."','".$_POST["relation"]."','".$_POST["stat"]."','".$_POST["stday"]." ".$_POST["sttime"]."','".$edday." ".$edtime."','".$_POST["q1_1a"]."','".$_POST["q1_1b_1"]."','".$_POST["q1_1b_2"]."','".$_POST["q1_1b_3"]."','".$_POST["q1_1b_4"]."','".$_POST["q1_1b_5"]."','".$_POST["q1_1b_5a"]."','".$_POST["q1_1b_6"]."','".$_POST["q2"]."','".$_POST["q2_1a"]."','".$_POST["q3"]."','".$_POST["q3_1a"]."','".$_POST["q4_a"]."','".$_POST["q4_a_1a"]."','".$_POST["q4_b"]."','".$_POST["q4_b_1a"]."','".$_POST["q5"]."','".$_POST["q5_e"]."','".$_POST["q6_1"]."','".$_POST["q6_2"]."','".$_POST["q6_3"]."','".$_POST["q6_4"]."','".$_POST["q7_1"]."','".$_POST["q7_1a"]."','".$_POST["q7_2"]."','".$_POST["q7_2a"]."','".$_POST["q7_3"]."','".$_POST["q7_3a"]."','".$_POST["q7_4"]."','".$_POST["q7_4a"]."','".$_POST["q7_5c"]."','".$_POST["q7_5"]."','".$_POST["q7_5a"]."','".$_POST["q8a"]."','".$_POST["q8a_34"]."','".$_POST["q8b"]."','".$_POST["q8b_34"]."','".$_POST["q9a"]."','".$_POST["q9a_34"]."','".$_POST["q9b"]."','".$_POST["q10"]."','".$_POST["q10_2"]."','".$_POST["q10_a"]."','".$_POST["q11"]."','".$_POST["q12"]."','".$_POST["q12_4a"]."')";
        //$result = mysql_query($sql,$link);
