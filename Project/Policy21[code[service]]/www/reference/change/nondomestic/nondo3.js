...
//---------------------------------------Tony---------------------------------------
	...
	//8_a
	$("input[name='q8_a']").attr("disabled",true);
	$("#q8_1").click(function() {
		    $("input[name='q8_a']").attr("disabled",false);
	});
	$("#q8_2").add("#q8_3").click(function() {
			$("input[name='q8_a']").prop("checked", false).attr("disabled",false);
			$("input[name='q8_a']").val("");
			//$("input[name='q8_a']").attr("disabled",true);
	...
	//q9_1b
	$("input[name='q9_1a']").attr("disabled",true);
	$("input[name='q9_1b']").attr("disabled",true);
	$("#q9_1").click(function() {
		    $("input[name='q9_1b']").attr("disabled",false);
	});
	$("#q9_2").add("#q9_3").click(function() {
			$("input[name='q9_1b']").prop("checked", false).attr("disabled",false);
			$("input[name='q9_1b']").val("");
			$("input[name='q9_1a']").prop("checked", false).attr("disabled",false);
			$("input[name='q9_1a']").val("");
...
function valids() {
	 ...
	 var quest = new Array();
		...
		quest[28] =  "";
					...
					if ($("#q8_a").val() > 100) {
						quest[28]= " 第8題(1)百分比都唔可以超過100,";
						bo = true;
					}
					
			if(bo){
			    	if ($("#stat1").val() == "C") {
						alert(" *_* 還有第 "+quest[0]+quest[1]+quest[2]+quest[3]+quest[4]+quest[5]+quest[6]+quest[7]+quest[8]+quest[9]+quest[10]+quest[11]+quest[12]+quest[13]+quest[14]+quest[15]+quest[16]+quest[17]+quest[18]+quest[19]+quest[20]+quest[21]+quest[22]+quest[23]+quest[24]+quest[25]+quest[26]+quest[28]+"沒有回答(⊙o⊙)!~~");
					    return false;
					}else{
					   var r=confirm("=*= 還有第 "+quest[0]+quest[1]+quest[2]+quest[3]+quest[4]+quest[5]+quest[6]+quest[7]+quest[8]+quest[9]+quest[10]+quest[11]+quest[12]+quest[13]+quest[14]+quest[15]+quest[16]+quest[17]+quest[18]+quest[19]+quest[20]+quest[21]+quest[22]+quest[23]+quest[24]+quest[25]+quest[26]+quest[27]+quest[28]+"沒有回答(⊙o⊙)喔~~是否提交?");
				       if (r==true) {
				           return true;
					     } else {
			            return false;
