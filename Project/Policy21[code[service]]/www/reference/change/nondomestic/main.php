...
<table width="1100">	
	...
	<tr>
	    <td class = "right"><input type = "radio" name = "q2b" id = "q2b_1" value = "1" <?php if (@$ans["q2b"] == "1") { echo "checked"; } ?>><label for = "q2b_1" >(1)非常能夠負擔</label></td>
	    <td class = "right"><input type = "radio" name = "q2b" id = "q2b_4" value = "4" <?php if (@$ans["q2b"] == "4") { echo "checked"; } ?>><label for = "q2b_4" >(4)非常不能夠負擔</label></td>
	</tr>
	<tr>
...
<table width="1100" >
	...
	<tr>
	 ...
	 <tr>	
	   <td class = "right" colspan = "2"><input type = "radio" name = "q5" id = "q5_e" value = "5" <?php if (@$ans["q5"] == "5") { echo "checked"; } ?>><label for = "q5_e" >(e)其他建議，請註明：</label><input type = "text" name = "q5_e" id = "q5_e" value = "<?php echo @$ans["q5_e"]; ?>"></td>		
	</tr>
</table></center>
</div>
<br>
...
<table width="1100" >
	 ...
	 <tr class="cg8_2"><td></td>
	     <td class = "right" colspan = "3">
			 ...
			 (i)<input type = "radio" name = "q8_2" id = "q8_2_9" value = "9" <?php if (@$ans["q8_2"] == "9") { echo "checked"; } ?>><label for = "q8_2_9" >大約5%</label>
	     </td>
	 </tr>
